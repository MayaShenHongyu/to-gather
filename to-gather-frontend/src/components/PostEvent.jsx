...
function PostEvent() {
  ...
  return (
    <div className="EventContainer" style={{ backgroundImage: `url(${BannerImage})` }}>
              ...
              <Grid container spacing={2} rowSpacing={1}>
                ...
                <Grid container item xs={4}>
                  <Grid item xs={12}>
                    ...
                    <MultiSelect 
                      label="tags"
                      options={['Sports','Art','Music','Show','Crafting',
                        'Social','Food','Outdoor','Culture','Entertainment']}
                      selected={tags}
                      setSelected={setTags}
                      style={{width: '250px', paddingTop: '10px', paddingBottom: '18px'}}  
                    />
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    ...
                    <TextField
                      ...
                      sx={{ width: 250 , paddingTop: '10px', paddingBottom: '18px'}}
                      InputLabelProps={{
                        shrink: true,
                      }}
                ...
                <Grid item xs={4}>
                  <h3 className="FieldTitle">UPLOAD EVENT IMAGE</h3>
                    <input type="file" style={{paddingTop: '10px'}} onChange={(event) => setImg(event.target.files[0])} />
                </Grid>
